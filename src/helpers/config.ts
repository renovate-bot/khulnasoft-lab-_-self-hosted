...
const config: SiteConfig = {
  ...
  workExperience: [
    ...
    {
      company: 'Freelance',
      companyUrl: 'https://self-hosted.khulnasoft.com/',
  ...
  projectComplimentaryData: [
    ...
    {
      name: 'self-hosted',
      thumbnail: 'https://i.ibb.co/ZhMTxmR/self-hosted-banner-image.png',
    },
    {
...
`,
  ...
  techStack: {
    ...
    frontend: [
      ...
      {
        language: 'Svelte',
        projects: ['self-hosted', 'cheat-code'],
      },
      {
        language: 'React',
        projects: ['web-check'],
  ...
  plausible: {
    ...
    domain: 'self-hosted.khulnasoft.com',
  },
};
